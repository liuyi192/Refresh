...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    /**
     * 从颜色资源中设置进度动画中使用的颜色。第一个颜色也是在反应中生长的颜色用户滑动手势。
     *
     * @param colors
     */
    ...
    private static class Ring {
        ...
        /**
         * 设置进度微调的绝对颜色。这是应该只在当前和下一种颜色之间进行动画时使用旋转器旋转。
         *
        ...
        /**
         * 如果开始/结束的装饰开始时偏移，将它们存储起来，以便动画从那个偏移量开始。
         */
