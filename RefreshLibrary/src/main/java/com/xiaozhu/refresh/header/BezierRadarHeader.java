package com.xiaozhu.refresh.header;
...
import com.xiaozhu.refresh.header.bezierradar.RippleView;
import com.xiaozhu.refresh.header.bezierradar.RoundDotView;
import com.xiaozhu.refresh.header.bezierradar.RoundProgressView;
import com.xiaozhu.refresh.header.bezierradar.WaveView;
...
public class BezierRadarHeader extends FrameLayout implements RefreshHeader {
    ...
    public void onStartAnimator(RefreshLayout layout, int headHeight, int extendHeight) {
        ...
        ValueAnimator animator = ValueAnimator.ofInt(mWaveView.getWaveHeight(), 0, -(int) (mWaveView.getWaveHeight() * 0.8), 0, -(int) (mWaveView.getWaveHeight() * 0.4f), 0);
