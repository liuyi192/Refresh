package com.xiaozhu.refresh.footer;
...
public class BallPulseFooter extends ViewGroup implements RefreshFooter {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        addView(mBallPulseView, MATCH_PARENT, WRAP_CONTENT);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(resolveSize(mBallPulseView.getMeasuredWidth(), widthMeasureSpec), resolveSize(mBallPulseView.getMeasuredHeight(), heightMeasureSpec));
    }
    ...
    public void setPrimaryColors(int... colors) {
        if (colors.length > 1) {
            ...
            mBallPulseView.setAnimatingColor(colors[1]);
