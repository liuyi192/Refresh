...
public class PathsDrawable extends Drawable {
    ...
    public void setBounds(int left, int top, int right, int bottom) {
        ...
        if (mOrginPaths != null && mOrginPaths.size() > 0 && (width != mWidth || height != mHeight)) {
    ...
    public void setGeometricWidth(int width) {
        ...
        setBounds((int) (bounds.left * rate), (int) (bounds.top * rate), (int) (bounds.right * rate), (int) (bounds.bottom * rate));
    }
